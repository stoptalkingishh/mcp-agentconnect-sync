...
tests/                       # 114 unit + e2e tests, run offline (stub backend + mTLS)
...
pytest -q                      # 114 passing, fully offline
...
**All six phases implemented end-to-end (offline, tested — 114 tests):** the
